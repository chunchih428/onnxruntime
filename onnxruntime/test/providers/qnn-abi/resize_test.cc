...
TEST_F(QnnCPUBackendABITests, ResizeUpsampleNearestHalfPixel_rpf) {
...
// coordinate_transformation_mode: "half_pixel"
TEST_F(QnnCPUBackendABITests, ResizeUpsampleNearestHalfPixel_rpc) {
...
// coordinate_transformation_mode: "half_pixel"
TEST_F(QnnCPUBackendABITests, ResizeDownsampleNearestHalfPixel_rpc) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  RunCPUResizeOpTest(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
// coordinate_transformation_mode: "half_pixel"
TEST_F(QnnCPUBackendABITests, ResizeDownsampleNearestHalfPixel_rpf) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  RunCPUResizeOpTest(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
TEST_F(QnnCPUBackendABITests, ResizeUpsampleNearestAlignCorners_rpf) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 70);
  RunCPUResizeOpTest(TestInputDef<float>({1, 2, 7, 5}, false, input_data),
...
TEST_F(QnnCPUBackendABITests, ResizeUpsampleNearestAsymmetric_rpf) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 70);
  RunCPUResizeOpTest(TestInputDef<float>({1, 2, 7, 5}, false, input_data),
...
// Upsample that uses "round_prefer_ceil" as the "nearest_mode".
// coordinate_transformation_mode: "align_corners"
TEST_F(QnnCPUBackendABITests, ResizeUpsampleNearestAlignCorners_rpc) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  RunCPUResizeOpTest(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
// Downsample that uses "round_prefer_ceil" as the "nearest_mode".
// coordinate_transformation_mode: "align_corners"
TEST_F(QnnCPUBackendABITests, ResizeDownsampleNearestAlignCorners_rpc) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  RunCPUResizeOpTest(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
// Downsample that uses "round_prefer_floor" as the "nearest_mode".
// coordinate_transformation_mode: "align_corners"
TEST_F(QnnCPUBackendABITests, ResizeDownsampleNearestAlignCorners_rpf) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  RunCPUResizeOpTest(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
TEST_F(QnnCPUBackendABITests, DISABLED_Resize2xLinearHalfPixel) {
...
TEST_F(QnnCPUBackendABITests, DISABLED_Resize2xLinearHalfPixel_scales) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 60);
...
TEST_F(QnnCPUBackendABITests, Resize2xLinearAlignCorners) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 60);
  RunCPUResizeOpTest(TestInputDef<float>({1, 3, 4, 5}, false, input_data),
...
TEST_F(QnnCPUBackendABITests, Resize2xLinearAlignCorners_scales) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 60);
  RunCPUResizeOpTestWithScales(TestInputDef<float>({1, 3, 4, 5}, false, input_data),
...
TEST_F(QnnCPUBackendABITests, Resize_DownSample_Linear_AlignCorners_scales) {
...
TEST_F(QnnCPUBackendABITests, DISABLED_Resize_DownSample_Linear_HalfPixel_scales) {
  std::vector<float> input_data = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f};
  RunCPUResizeOpTestWithScales(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, Resize_DownSample_Linear_AlignCorners) {
  std::vector<float> input_data = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f};
...
// Maps to QNN's ResizeBilinear operator.
TEST_F(QnnHTPBackendABITests, Resize_DownSample_Linear_HalfPixel) {
  std::vector<float> input_data = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f};
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 1, 2, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_2xLinearPytorchHalfPixel) {
...
// Maps to QNN's ResizeBilinear operator.
TEST_F(QnnHTPBackendABITests, ResizeU8_2xLinearHalfPixel) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
// Maps to QNN's ResizeBilinear operator.
TEST_F(QnnHTPBackendABITests, ResizeU8_2xLinearAlignCorners) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
// Maps to QNN's ResizeBilinear operator.
TEST_F(QnnHTPBackendABITests, ResizeU8_2xLinearAsymmetric) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_2xNearestHalfPixelRoundPreferFloor_Unsupported) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_2xNearestHalfPixelRoundPreferCeil) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_2xNearestAlignCornersRoundPreferCeil) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_NearestModeCeil_Unsupported) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, ResizeU8_3xNearestAsymmetricFloor) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
...
// Maps to QNN's Resize operator.
// UPDATE: "round_prefer_floor" no longer supported in QNN SDK 2.21 (supported in QNN SDK 2.19)
TEST_F(QnnHTPBackendABITests, ResizeU8_2xNearestAsymmetricRoundPreferFloor_Unsupported) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
// UPDATE: "round_prefer_floor" no longer supported in QNN SDK 2.21 (supported in QNN SDK 2.19)
TEST_F(QnnHTPBackendABITests, ResizeU8_3xNearestAsymmetricRoundPreferFloor_Unsupported) {
...
// Maps to QNN's ResizeNearestNeighbor operator.
TEST_F(QnnHTPBackendABITests, ResizeU8_HalfNearestAsymmetricFloor) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunQDQResizeOpTest<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, input_data),
