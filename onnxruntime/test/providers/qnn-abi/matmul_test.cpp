...
// CPU tests:
//
TEST_F(QnnCPUBackendABITests, MatMulOp) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_MatMulOp) {
...
TEST_F(QnnHTPBackendABITests, MatMulOp_QDQ) {
  // UINT8
...
TEST_F(QnnHTPBackendABITests, MatMulOp_QDQ_Regression_uint16_dynamic_inputs) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
// This workaround prevents a validation error for this specific MatMul configuration.
// Got specific shapes and input ranges (quant params) from customer model.
TEST_F(QnnHTPBackendABITests, MatMulOp_QDQ_Regression_uint16_static_weight) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
