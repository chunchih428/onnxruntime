...
TEST_F(QnnHTPBackendABITests, DISABLED_CumSum_float_int32_e0_r0_axis_0) {
...
// Fails with QNN SDK 2.35.0:
// Failed to finalize QNN graph. Error code: 1002
TEST_F(QnnHTPBackendABITests, DISABLED_CumSum_float_int32_e0_r0_axis_neg1) {
  RunCumSumOpTest<float, int32_t>("CumSum",
                                  TestInputDef<float>({3, 2}, false, {1.3f, 7.2f, 0.4f, 3.4f, 5.7f, 0.8f}),
...
TEST_F(QnnHTPBackendABITests, CumSum_uint8_int32_e0_r0) {
