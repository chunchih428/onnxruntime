...
TEST_F(QnnCPUBackendABITests, AveragePool_AsGlobal) {
...
TEST_F(QnnCPUBackendABITests, GlobalAveragePool) {
...
TEST_F(QnnCPUBackendABITests, AveragePool_CountIncludePad) {
  RunAveragePoolOpTest("AveragePool",
                       {TestInputDef<float>({1, 2, 3, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 18))},
...
TEST_F(QnnCPUBackendABITests, AveragePool_AutopadSameUpper) {
  RunAveragePoolOpTest("AveragePool",
                       {TestInputDef<float>({1, 2, 3, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 18))},
                       {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{1, 1}),
                        utils::MakeAttribute("count_include_pad", static_cast<int64_t>(1)),
...
TEST_F(QnnCPUBackendABITests, AveragePool_AutopadSameLower) {
  RunAveragePoolOpTest("AveragePool",
                       {TestInputDef<float>({1, 2, 3, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 18))},
                       {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{1, 1}),
                        utils::MakeAttribute("count_include_pad", static_cast<int64_t>(1)),
...
TEST_F(QnnHTPBackendABITests, AveragePool_AsGlobal) {
...
TEST_F(QnnHTPBackendABITests, GlobalAveragePool) {
...
TEST_F(QnnHTPBackendABITests, AveragePool_CountIncludePad_HTP_u8) {
...
TEST_F(QnnHTPBackendABITests, AveragePool_AutopadSameUpper_HTP_u8) {
  std::vector<float> input = {-9.0f, -7.33f, -6.0f, -5.0f, -4.0f, -3.0f, -2.0f, -1.0f, 0.0f,
                              1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f};
...
TEST_F(QnnHTPBackendABITests, AveragePool_AutopadSameLower_HTP_u8) {
  std::vector<float> input = {-9.0f, -7.33f, -6.0f, -5.0f, -4.0f, -3.0f, -2.0f, -1.0f, 0.0f,
                              1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f};
