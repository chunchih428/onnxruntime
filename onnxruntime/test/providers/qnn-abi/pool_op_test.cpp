...
TEST_F(QnnCPUBackendABITests, MaxPool_Global) {
...
TEST_F(QnnCPUBackendABITests, MaxPool_Large_Input) {
  RunPoolOpTest("MaxPool",
...
TEST_F(QnnCPUBackendABITests, DISABLED_MaxPool_Ceil) {
  RunPoolOpTest("MaxPool",
                TestInputDef<float>({1, 2, 3, 3}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3, 3}),
                 utils::MakeAttribute("strides", std::vector<int64_t>{3, 3}),
...
// Fails on QNN v2.17, QNN.graphAddNode() failed for node `MaxPool` of type `PoolMax2d` with error code 6000
TEST_F(QnnCPUBackendABITests, DISABLED_MaxPool_Large_Input2_Ceil) {
  RunPoolOpTest("MaxPool",
...
// GlobalMaxPool test
TEST_F(QnnCPUBackendABITests, GlobalMaxPoolTest) {
...
TEST_F(QnnHTPBackendABITests, MaxPool_Global_HTP_u8) {
...
TEST_F(QnnHTPBackendABITests, MaxPool_Large_Input_HTP_u8) {
  RunQDQPoolOpTest<uint8_t>("MaxPool",
                            TestInputDef<float>({1, 125, 8, 56}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                            {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{2, 2}),
                             utils::MakeAttribute("strides", std::vector<int64_t>{2, 2}),
...
TEST_F(QnnHTPBackendABITests, MaxPool1D_ReshapeNodesPresent) {
...
TEST_F(QnnHTPBackendABITests, MaxPool_Rank3_HTP_u8) {
...
TEST_F(QnnHTPBackendABITests, MaxPool_Rank3_Ceil_HTP_u8) {
  RunQDQPoolOpTest<uint8_t>(
      "MaxPool",
      TestInputDef<float>({1, 3, 3}, false, -10.0f, 10.0f),
      {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3}),
...
TEST_F(QnnHTPBackendABITests, MaxPool_Rank3_Ceil_HTP_u8_auto_pad_VALID) {
  RunQDQPoolOpTest<uint8_t>(
      "MaxPool",
      TestInputDef<float>({1, 3, 3}, false, -10.0f, 10.0f),
      {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3}),
...
TEST_F(QnnHTPBackendABITests, MaxPool_Rank3_Ceil_HTP_u8_auto_pad_SAME_UPPER) {
  RunQDQPoolOpTest<uint8_t>(
      "MaxPool",
      TestInputDef<float>({1, 3, 3}, false, -10.0f, 10.0f),
      {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3}),
...
TEST_F(QnnHTPBackendABITests, MaxPool_Rank3_Ceil_HTP_u8_auto_pad_SAME_LOWER) {
  RunQDQPoolOpTest<uint8_t>(
      "MaxPool",
      TestInputDef<float>({1, 3, 3}, false, -10.0f, 10.0f),
      {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3}),
...
TEST_F(QnnHTPBackendABITests, MaxPool_Ceil_HTP_u8) {
  RunQDQPoolOpTest<uint8_t>("MaxPool",
                            TestInputDef<float>({1, 2, 3, 3}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                            {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{3, 3}),
                             utils::MakeAttribute("strides", std::vector<int64_t>{3, 3}),
...
TEST_F(QnnHTPBackendABITests, DISABLED_MaxPool_Large_Input2_Ceil_HTP_u8) {
  RunQDQPoolOpTest<uint8_t>("MaxPool",
                            TestInputDef<float>({1, 128, 16, 113}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                            {utils::MakeAttribute("kernel_shape", std::vector<int64_t>{2, 2}),
                             utils::MakeAttribute("strides", std::vector<int64_t>{2, 2}),
...
TEST_F(QnnHTPBackendABITests, MaxPool_Large_Input3_AutoPadValid_HTP_u8) {
  RunQDQPoolOpTest<uint8_t>("MaxPool",
...
TEST_F(QnnHTPBackendABITests, MaxPool_LargeInput_1Pads_u8) {
  RunQDQPoolOpTest<uint8_t>("MaxPool",
...
TEST_F(QnnHTPBackendABITests, MaxPool_LargeInput_1Pads_u16) {
...
TEST_F(QnnHTPBackendABITests, GlobalMaxPool_u8) {
...
TEST_F(QnnHTPBackendABITests, GlobalMaxPool_u16) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 18);
...
TEST_F(QnnHTPBackendABITests, GlobalMaxPool_Large_Input_u8) {
  RunQDQPoolOpTest<uint8_t>("GlobalMaxPool",
                            TestInputDef<float>({1, 128, 16, 113}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                            {},
                            ExpectedEPNodeAssignment::All);
...
TEST_F(QnnHTPBackendABITests, GlobalMaxPool_LargeInput2_u8) {
  RunQDQPoolOpTest<uint8_t>("GlobalMaxPool",
                            TestInputDef<float>({1, 64, 384, 576}, false, -10.0f, 10.0f),  // Dynamic input with range [-10, 10]
                            {},
                            ExpectedEPNodeAssignment::All);
