...
TEST_F(QnnCPUBackendABITests, EinsumRank2) {
...
TEST_F(QnnCPUBackendABITests, EinsumRank4MatMul) {
...
TEST_F(QnnCPUBackendABITests, EinsumRank4MatMulTransposeY) {
...
TEST_F(QnnCPUBackendABITests, EinsumRank4MatMulTransposeAll1) {
...
TEST_F(QnnCPUBackendABITests, EinsumRank4MatMulTransposeAll2) {
...
TEST_F(QnnHTPBackendABITests, EinsumF16Rank2MatMul) {
  const std::vector<int64_t> shape0{2, 3};
  const std::vector<int64_t> shape1{3, 4};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
...
TEST_F(QnnHTPBackendABITests, EinsumF16Rank4MatMul) {
...
TEST_F(QnnHTPBackendABITests, EinsumF16Rank4MatMulTransposeY) {
...
TEST_F(QnnHTPBackendABITests, EinsumF16Rank4MatMulTransposeAll1) {
...
TEST_F(QnnHTPBackendABITests, EinsumF16Rank4MatMulTransposeAll2) {
...
TEST_F(QnnHTPBackendABITests, EinsumQdqRank2MatMul) {
  const std::vector<int64_t> shape0{2, 3};
  const std::vector<int64_t> shape1{3, 4};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
...
TEST_F(QnnHTPBackendABITests, EinsumQdqRank4MatMul) {
  const std::vector<int64_t> shape0{3, 1, 5, 2};
  const std::vector<int64_t> shape1{3, 1, 2, 5};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
...
TEST_F(QnnHTPBackendABITests, EinsumQdqRank4MatMulTransposeY) {
  const std::vector<int64_t> shape0{2, 3, 4, 2};
  const std::vector<int64_t> shape1{2, 3, 5, 2};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
...
TEST_F(QnnHTPBackendABITests, EinsumQdqRank4MatMulTransposeAll1) {
  const std::vector<int64_t> shape0{1, 3, 1, 7};
  const std::vector<int64_t> shape1{1, 7, 1, 3};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
...
TEST_F(QnnHTPBackendABITests, EinsumQdqRank4MatMulTransposeAll2) {
  const std::vector<int64_t> shape0{1, 4, 1, 4};
  const std::vector<int64_t> shape1{1, 9, 1, 4};
  const std::vector<float> data0 = GetSequentialFloatData(shape0, /*start=*/-0.1f, /*step=*/0.05f);
  const std::vector<float> data1 = GetSequentialFloatData(shape1, /*start=*/-0.1f, /*step=*/0.05f);
