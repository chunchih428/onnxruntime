...
TEST_F(QnnCPUBackendABITests, LRNSize3) {
  RunCPULRNOpTest(TestInputDef<float>({1, 128, 4, 5}, false, -10.0f, 10.0f),
                  3,  // Size
                  ExpectedEPNodeAssignment::All);
}

TEST_F(QnnCPUBackendABITests, LRNSize5) {
  RunCPULRNOpTest(TestInputDef<float>({1, 128, 4, 5}, false, -10.0f, 10.0f),
                  5,  // Size
                  ExpectedEPNodeAssignment::All);
}

TEST_F(QnnCPUBackendABITests, LRN_size_larger_than_channel) {
  RunCPULRNOpTest(TestInputDef<float>({1, 128, 4, 5}, false, -10.0f, 10.0f),
                  255,  // Size
                  ExpectedEPNodeAssignment::All);
}
...
TEST_F(QnnHTPBackendABITests, LRNSize3) {
...
TEST_F(QnnHTPBackendABITests, LRNSize5) {
  RunQDQLRNOpTest<uint8_t>(TestInputDef<float>({1, 128, 4, 5}, false, -10.0f, 10.0f),
                           5,  // Size
                           ExpectedEPNodeAssignment::All,
                           0.0001f,  // alpha
...
TEST_F(QnnHTPBackendABITests, LRN_size_larger_than_channel) {
  RunQDQLRNOpTest<uint8_t>(TestInputDef<float>({1, 128, 4, 5}, false, -10.0f, 10.0f),
                           255,  // Size
                           ExpectedEPNodeAssignment::All,
                           0.0001f,  // alpha
