...
// and 'split' input.
TEST_F(QnnCPUBackendABITests, Split_Equal_Axis0_Opset18) {
...
TEST_F(QnnCPUBackendABITests, Split_Equal_Axis0_Opset13) {
  RunSplitOpTestOnCPU<float>(TestInputDef<float>({4, 2}, false, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.f, 8.f}),
                             {2, 2},  // split
                             0,       // axis
...
TEST_F(QnnCPUBackendABITests, Split_Equal_Axis0_Opset11) {
  RunSplitOpTestOnCPU<float>(TestInputDef<float>({4, 2}, false, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.f, 8.f}),
                             {2, 2},  // split
                             0,       // axis
...
TEST_F(QnnCPUBackendABITests, Split_Unequal_Axis1_Opset13) {
...
TEST_F(QnnCPUBackendABITests, Split_Unequal_Axis1_Opset11) {
  RunSplitOpTestOnCPU<float>(TestInputDef<float>({2, 4}, false, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.f, 8.f}),
                             {1, 3},  // split
                             1,       // axis
                             -1,      // num_outputs (not in opset 11)
...
TEST_F(QnnHTPBackendABITests, Split_Int32_Opset13) {
  // Equal split.
...
// and 'split' input.
TEST_F(QnnHTPBackendABITests, Split_Equal_Axis0_Opset18) {
...
TEST_F(QnnHTPBackendABITests, Split_NonEqual_Axis0_Opset18) {
...
// and 'split' input.
TEST_F(QnnHTPBackendABITests, Split_Equal_Axis0_Opset18_U16) {
  // Use 'split' input (initializer).
...
TEST_F(QnnHTPBackendABITests, Split_Equal_Axis0_Opset13) {
...
TEST_F(QnnHTPBackendABITests, Split_Equal_Axis0_Opset11) {
  RunQDQSplitOpTestOnHTP<uint8_t>(TestInputDef<float>({4, 2}, false, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.f, 8.f}),
                                  {2, 2},  // split
                                  0,       // axis
                                  -1,      // num_outputs (not in opset 11)
...
TEST_F(QnnHTPBackendABITests, Split_Unequal_Axis1_Opset13) {
...
TEST_F(QnnHTPBackendABITests, Split_Unequal_Axis1_Opset11) {
  RunQDQSplitOpTestOnHTP<uint8_t>(TestInputDef<float>({2, 4}, false, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.f, 8.f}),
                                  {1, 3},  // split
                                  1,       // axis
                                  -1,      // num_outputs (not in opset 11)
