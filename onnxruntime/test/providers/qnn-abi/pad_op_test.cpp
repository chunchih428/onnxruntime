...
// Pad 2d
TEST_F(QnnCPUBackendABITests, Pad2d) {
...
TEST_F(QnnCPUBackendABITests, Pad2dPadsNotIni) {
  RunPadOpTest(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
...
// fixed by QNN 2.32
TEST_F(QnnCPUBackendABITests, PadModeReflect) {
...
// Pad edge mode
TEST_F(QnnCPUBackendABITests, PadModeEdge) {
  bool has_constant_value = false;
  RunPadOpTest(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
               TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
               TestInputDef<float>({1}, true, {0.0f}),
...
TEST_F(QnnCPUBackendABITests, PadModeWrap) {
  bool has_constant_value = false;
  RunPadOpTest(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
               TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
               TestInputDef<float>({1}, true, {0.0f}),
...
// Pad 4d
TEST_F(QnnCPUBackendABITests, Pad4d) {
...
// Pad 5d supported
TEST_F(QnnCPUBackendABITests, Pad5d) {
...
// Pad 6d supported
TEST_F(QnnCPUBackendABITests, Pad6d) {
...
//
// HTP tests:
TEST_F(QnnHTPBackendABITests, PadNoConstantValue_fp16_test) {
...
TEST_F(QnnHTPBackendABITests, PadReflectMode_fp16) {
  bool has_constant_value_input = false;
  bool use_htp = true;
  bool enable_fp16_precision = true;
  RunPadOpTest(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
...
TEST_F(QnnHTPBackendABITests, DISABLED_PadReflectMode_FP16_big_data) {
  bool has_constant_value_input = false;
  bool use_htp = true;
  bool enable_fp16_precision = true;
...
//
// QDQ Pad
TEST_F(QnnHTPBackendABITests, PadNoConstantValue) {
  bool has_constant_value_input = false;
...
TEST_F(QnnHTPBackendABITests, PadHasConstantValueNonQuantized) {
...
TEST_F(QnnHTPBackendABITests, PadHasConstantValueQuantized) {
  bool has_constant_value_input = true;
  bool constant_value_quantized = true;
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
                           TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
...
TEST_F(QnnHTPBackendABITests, PadReflectMode) {
  bool has_constant_value_input = false;
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
                           TestInputDef<int64_t>({4}, true, {0, 1, 0, 0}),
                           TestInputDef<float>({1}, true, {0.0f}),
...
TEST_F(QnnHTPBackendABITests, PadReflectModeOutOfRangePadAmount) {
  bool has_constant_value_input = false;
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
                           TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
                           TestInputDef<float>({1}, true, {0.0f}),
...
TEST_F(QnnHTPBackendABITests, Pad4dReflectMode) {
  bool has_constant_value_input = false;
...
TEST_F(QnnHTPBackendABITests, PadEdgeMode) {
  bool has_constant_value_input = false;
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
                           TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
                           TestInputDef<float>({1}, true, {0.0f}),
...
TEST_F(QnnHTPBackendABITests, PadWrapMode) {
  bool has_constant_value_input = false;
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.6f}),
                           TestInputDef<int64_t>({4}, true, {0, 2, 0, 0}),
                           TestInputDef<float>({1}, true, {0.0f}),
...
TEST_F(QnnHTPBackendABITests, Pad4d) {
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({1, 2, 2, 2}, false,
                                               {1.0f, 2.0f,
                                                3.0f, 4.0f,
                                                5.0f, 6.0f,
...
TEST_F(QnnHTPBackendABITests, DISABLED_Pad4dOutOfRangePadConstantValue) {
  RunQDQPadOpTest<uint8_t>(TestInputDef<float>({1, 2, 2, 2}, false,
                                               {1.0f, 2.0f,
                                                3.0f, 4.0f,
                                                5.0f, 6.0f,
...
TEST_F(QnnHTPBackendABITests, Pad5d) {
