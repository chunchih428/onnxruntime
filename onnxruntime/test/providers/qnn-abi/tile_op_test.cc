...
TEST_F(QnnCPUBackendABITests, Tile_DynamicRepeats_Unsupported) {
...
TEST_F(QnnCPUBackendABITests, Tile_F32_Rank4) {
...
TEST_F(QnnHTPBackendABITests, Tile_U8_Rank4) {
  std::vector<float> input_data = {-4.0f, -3.0f, -1.0f, 0.0f, 1.0f, 2.0f, 3.0f, 4.0f};
...
TEST_F(QnnHTPBackendABITests, Tile_U16_Rank4) {
  std::vector<float> input_data = {-4.0f, -3.0f, -1.0f, 0.0f, 1.0f, 2.0f, 3.0f, 4.0f};
