...
TEST_F(QnnHTPBackendABITests, WhereQDQU8) {
...
TEST_F(QnnHTPBackendABITests, WhereBroadcastU8) {
...
TEST_F(QnnHTPBackendABITests, WhereLargeDataU8) {
...
TEST_F(QnnHTPBackendABITests, WhereLargeDataBroadcastU8) {
  RunWhereQDQTest(TestInputDef<bool>({5120}, false, false, true),
...
TEST_F(QnnHTPBackendABITests, WhereLargeDataBroadcastTransformedU8) {
