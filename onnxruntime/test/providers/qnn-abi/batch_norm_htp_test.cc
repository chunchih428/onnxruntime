...
TEST_F(QnnHTPBackendABITests, BatchNormRank2) {
...
#if defined(_WIN32)
TEST_F(QnnHTPBackendABITests, BatchNorm1D) {
  constexpr int64_t num_channels = 2;
...
TEST_F(QnnHTPBackendABITests, BatchNorm2D_a8w8) {
  constexpr int64_t num_channels = 2;
...
// Check that QNN compiles DQ -> BatchNormalization -> Q as a single unit.
// Use an input of rank 4.
TEST_F(QnnHTPBackendABITests, BatchNorm2D_a16w8) {
  constexpr int64_t num_channels = 2;
  std::vector<float> input_data = {-8.0f, -6.0f, -4.0f, -2.0f, 0.0f, 1.1f, 3.3f, 8.0f,
                                   -7.0f, -5.0f, -3.0f, -1.0f, 0.0f, 2.1f, 4.3f, 7.0f};
...
TEST_F(QnnHTPBackendABITests, BatchNorm_FP16) {
  constexpr int64_t num_channels = 2;
  std::vector<float> input_data = {-8.0f, -6.0f, -4.0f, -2.0f, 0.0f, 1.1f, 3.3f, 8.0f,
                                   -7.0f, -5.0f, -3.0f, -1.0f, 0.0f, 2.1f, 4.3f, 7.0f};
...
TEST_F(QnnHTPBackendABITests, BatchNorm_FP32_as_FP16) {
  ProviderOptions provider_options;
...
TEST_F(QnnHTPBackendABITests, BatchNorm3D) {
  constexpr int64_t num_channels = 2;
