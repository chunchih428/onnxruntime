...
TEST_F(QnnCPUBackendABITests, Upsample_DynamicScales_Unsupported) {
...
TEST_F(QnnCPUBackendABITests, Upsample_4D_Nearest_opset9) {
  RunUpsampleTestOnCPU(TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
...
TEST_F(QnnCPUBackendABITests, Upsample_4D_Linear_opset9) {
  RunUpsampleTestOnCPU(TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
...
TEST_F(QnnCPUBackendABITests, Upsample_4D_Nearest_opset7) {
  RunUpsampleTestOnCPU(TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                       {utils::MakeAttribute("mode", "nearest")},  // Attributes
                       ExpectedEPNodeAssignment::All,
...
TEST_F(QnnCPUBackendABITests, Upsample_4D_Linear_opset7) {
  RunUpsampleTestOnCPU(TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                       TestInputDef<float>({4}, true, {1.0f, 1.0f, 1.5f, 1.5f}),
                       {utils::MakeAttribute("mode", "linear")},  // Attributes
                       ExpectedEPNodeAssignment::All,
...
// Test Upsample 5D
TEST_F(QnnCPUBackendABITests, Upsample_5D) {
