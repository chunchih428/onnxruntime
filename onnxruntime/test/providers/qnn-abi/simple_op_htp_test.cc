...
// fixed by QNN 2.32
TEST_F(QnnCPUBackendABITests, SpaceToDepth_Flaky) {
  std::vector<float> X =
      {0.0f, 0.1f, 0.2f, 0.3f,
       1.0f, 1.1f, 1.2f, 1.3f,
...
// fixed by QNN 2.32
TEST_F(QnnCPUBackendABITests, SpaceToDepth_Flaky2) {
...
TEST_F(QnnCPUBackendABITests, DISABLED_UnaryOp_Relu) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Sigmoid) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Sigmoid_U16) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Tanh) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Tanh_U16) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Gelu) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Gelu_U16) {
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Elu) {
...
// Issue fixed in 2.30
TEST_F(QnnHTPBackendABITests, UnaryOp_Elu_U16) {
...
// CPU QDQ val: 0 (err 0)
TEST_F(QnnHTPBackendABITests, UnaryOp_Relu) {
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSwish) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSwish_U16) {
  const std::vector<float> input_data = {-10.0f, -8.4f, 0.0f, 4.3f, 7.1f, 10.0f};
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Atan) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Atan_U16) {
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Asin) {
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Sign) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Sign_U16) {
  const std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 6);
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Sin) {
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Cos) {
...
// Check that QNN compiles DQ -> Cos -> Q as a single unit.
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Cos_InaccurateFixed) {
  RunQDQOpTest<uint8_t>("Cos",
...
// Use an input of rank 3.
TEST_F(QnnHTPBackendABITests, UnaryOp_Log) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Exp) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Sqrt) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Neg) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 6);
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Not) {
  RunOpTest<bool>("Not",
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Round) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Log_U16) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax13_DefaultAxis) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax13_U16_DefaultAxis) {
  const std::vector<float> input_data = GetFloatDataInRange(-5.0f, 5.0f, 6);
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax13_NonLastAxis) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax13_NonLastAxis_LargeInput) {
...
// QNN EP will wrap the operator with transposes.
// This is a configuration used in one of our partner's models.
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax13_U16_NonLastAxis_LargeInput) {
  const std::vector<float> input_data = GetFloatDataInRange(-50.0f, 50.0f, 124);
  RunQDQOpTest<uint16_t>("Softmax",
                         {TestInputDef<float>({1, 124, 1}, false, input_data)},
                         {utils::MakeAttribute("axis", static_cast<int64_t>(1))},
...
// Check that QNN compiles DQ -> Softmax -> Q as a single unit.
// Test that the default axis (1) for SoftMax opset < 13 works.
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax11_DefaultAxis) {
  RunQDQOpTest<uint8_t>("Softmax",
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Softmax11_SetAxis) {
  RunQDQOpTest<uint8_t>("Softmax",
                        {TestInputDef<float>({1, 2, 3}, false, -5.0f, 5.0f)},
                        {utils::MakeAttribute("axis", static_cast<int64_t>(-1))},
                        11,
...
TEST_F(QnnHTPBackendABITests, UnaryOp_LogSoftmax13_DefaultAxis) {
...
// QNN EP will wrap the operator with transposes.
TEST_F(QnnHTPBackendABITests, UnaryOp_LogSoftmax13_NonLastAxis) {
  std::vector<float> input_data = GetFloatDataInRange(-5.0f, 5.0f, 6);
  RunQDQOpTest<uint8_t>("LogSoftmax",
                        {TestInputDef<float>({1, 2, 3}, false, input_data)},
                        {utils::MakeAttribute("axis", static_cast<int64_t>(1))},
...
// Check that QNN compiles DQ -> LogSoftmax -> Q as a single unit.
// Test that the default axis (1) for LogSoftmax opset < 13 works.
TEST_F(QnnHTPBackendABITests, UnaryOp_LogSoftmax11_DefaultAxis) {
  std::vector<float> input_data = GetFloatDataInRange(-5.0f, 5.0f, 6);
  RunQDQOpTest<uint8_t>("LogSoftmax",
                        {TestInputDef<float>({1, 2, 3}, false, input_data)},
                        {},  // Uses default axis of 1 for opset < 13.
...
TEST_F(QnnHTPBackendABITests, UnaryOp_LogSoftmax11_SetAxis) {
  std::vector<float> input_data = GetFloatDataInRange(-5.0f, 5.0f, 6);
  RunQDQOpTest<uint8_t>("LogSoftmax",
                        {TestInputDef<float>({1, 2, 3}, false, input_data)},
                        {utils::MakeAttribute("axis", static_cast<int64_t>(-1))},
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Abs) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Abs_U16) {
  const std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 6);
...
TEST_F(QnnHTPBackendABITests, UnaryOp_Ceil) {
...
// Issue fixed in 2.30
TEST_F(QnnHTPBackendABITests, UnaryOp_Ceil_U16) {
  const std::vector<float> input_data = GetFloatDataInRange(-12.0f, 12.0f, 6);
...
// Test QDQ Floor op.
TEST_F(QnnHTPBackendABITests, UnaryOp_Floor) {
  const std::vector<float> input_data = GetFloatDataInRange(-12.0f, 12.0f, 6);
...
TEST_F(QnnHTPBackendABITests, DepthToSpaceOp_CRD) {
...
TEST_F(QnnHTPBackendABITests, DepthToSpaceOp_U16_CRD) {
  const std::vector<float> X = {0., 1., 2.,
                                3., 4., 5.,
                                9., 10., 11.,
                                12., 13., 14.,
...
// Test QDQ DepthToSpace.
TEST_F(QnnHTPBackendABITests, DepthToSpaceOp_DCR) {
  const std::vector<float> X = {0., 1., 2.,
                                3., 4., 5.,
                                9., 10., 11.,
                                12., 13., 14.,
...
TEST_F(QnnHTPBackendABITests, SpaceToDepthOp) {
...
TEST_F(QnnHTPBackendABITests, SpaceToDepthOp_U16) {
  const std::vector<float> X = {0.0f, 0.1f, 0.2f, 0.3f,
                                1.0f, 1.1f, 1.2f, 1.3f,
...
TEST_F(QnnHTPBackendABITests, QuantAccuracyTest) {
  ProviderOptions provider_options;
...
// Test 8-bit QDQ Add
TEST_F(QnnHTPBackendABITests, BinaryOp_Add4D) {
...
// Test 16-bit QDQ Add
TEST_F(QnnHTPBackendABITests, BinaryOp_Add4D_U16) {
...
// Test 8-bit QDQ Sub
TEST_F(QnnHTPBackendABITests, BinaryOp_Sub4D) {
...
// Test 16-bit QDQ Sub
TEST_F(QnnHTPBackendABITests, BinaryOp_Sub4D_U16) {
...
TEST_F(QnnHTPBackendABITests, BinaryOp_Sub4D_LargeInputs) {
  RunQDQOpTest<uint8_t>("Sub",
...
TEST_F(QnnHTPBackendABITests, BinaryOp_Sub4D_Broadcast) {
  RunQDQOpTest<uint8_t>("Sub",
                        {TestInputDef<float>({1, 3, 768, 1152}, false, -1.0f, 1.0f),
...
TEST_F(QnnHTPBackendABITests, DISABLED_BinaryOp_Pow) {
#else
TEST_F(QnnHTPBackendABITests, BinaryOp_Pow) {
#endif
...
TEST_F(QnnHTPBackendABITests, BinaryOp_PRelu_DynamicSlopes) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
TEST_F(QnnHTPBackendABITests, BinaryOp_PRelu_StaticSlopes) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
  std::vector<float> slopes_data = GetFloatDataInRange(-1.0f, 1.0f, 8);
  RunQDQOpTest<uint8_t>("PRelu",
                        {TestInputDef<float>({1, 2, 2, 2}, false, input_data),
...
TEST_F(QnnHTPBackendABITests, BinaryOp_Div4D_SmallInputs) {
...
TEST_F(QnnHTPBackendABITests, BinaryOp_Div4D_U16_SmallInputs) {
  std::vector<float> input0_data = {-10.0f, -8.0f, -1.0f, 0.0f, 1.0f, 2.1f, 8.0f, 10.0f};
  std::vector<float> input1_data = {5.0f, 4.0f, 1.0f, 1.0f, 1.0f, 4.0f, 4.0f, 5.0f};
...
TEST_F(QnnHTPBackendABITests, DISABLED_BinaryOp_Div4D_LargeInputs) {
  RunQDQOpTest<uint8_t>("Div",
                        {TestInputDef<float>({1, 3, 768, 1152}, false, -1.0f, 1.0f),
                         TestInputDef<float>({1, 3, 768, 1152}, false, -1.0f, 1.0f)},
                        {},
...
TEST_F(QnnHTPBackendABITests, BinaryOp_Div4D_Broadcast) {
  RunQDQOpTest<uint8_t>("Div",
                        {TestInputDef<float>({1, 3, 768, 1152}, false, -1.0f, 1.0f),
                         TestInputDef<float>({3, 1, 1}, true, {1.0f, 0.5f, -0.3f})},
                        {},
...
// Test 8-bit QDQ Mul
TEST_F(QnnHTPBackendABITests, BinaryOp_Mul4D) {
...
// Test 16-bit QDQ Mul
TEST_F(QnnHTPBackendABITests, BinaryOp_Mul4D_U16) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
// Test And
TEST_F(QnnHTPBackendABITests, BinaryOp_And4D) {
  RunOpTest<bool>("And",
                  {TestInputDef<bool>({1, 4}, false, {false, false, true, true}),
...
TEST_F(QnnHTPBackendABITests, Reciprocal_Basic_FLOAT) {
...
TEST_F(QnnHTPBackendABITests, Reciprocal_QU8) {
...
// Test Mean Op on HTP
TEST_F(QnnHTPBackendABITests, Mean_TwoInputs) {
...
TEST_F(QnnHTPBackendABITests, Mean_FourInputs) {
...
TEST_F(QnnHTPBackendABITests, Mean_TwoInputs_QU8) {
...
TEST_F(QnnHTPBackendABITests, Mean_FourInputs_QU8) {
  RunQDQOpTest<uint8_t>("Mean",
                        {TestInputDef<float>({1, 2, 2}, false, GetFloatDataInRange(0.0f, 10.0f, 4)),
                         TestInputDef<float>({1, 2, 2}, false, GetFloatDataInRange(10.0f, 20.0f, 4)),
...
TEST_F(QnnHTPBackendABITests, ScatterND_int64_int64) {
...
TEST_F(QnnHTPBackendABITests, BinaryOp_HTP_Or_Unsupported) {
  RunOpTest<bool>("Or",
                  {TestInputDef<bool>({1, 4}, false, {false, false, true, true}),
                   TestInputDef<bool>({1, 4}, false, {false, true, false, true})},
                  {},
...
TEST_F(QnnHTPBackendABITests, ScatterND_int64_int64_reduction_add) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
  RunOpTest<int64_t>("ScatterND",
...
TEST_F(QnnHTPBackendABITests, ScatterND_int64_int64_reduction_mul) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
  RunOpTest<int64_t>("ScatterND",
...
TEST_F(QnnHTPBackendABITests, ScatterND_int64_int64_reduction_max) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
  RunOpTest<int64_t>("ScatterND",
...
TEST_F(QnnHTPBackendABITests, ScatterND_int64_int64_reduction_min) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
  RunOpTest<int64_t>("ScatterND",
...
TEST_F(QnnHTPBackendABITests, GridSample_Bilinear) {
...
TEST_F(QnnHTPBackendABITests, GridSample_U16_Bilinear) {
...
TEST_F(QnnHTPBackendABITests, GridSample_AlignCorners) {
  RunQDQOpTest<uint8_t>("GridSample",
                        {TestInputDef<float>({1, 1, 3, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 6)),
                         TestInputDef<float>({1, 2, 4, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 16))},
...
TEST_F(QnnHTPBackendABITests, GridSample_U16_AlignCorners) {
  RunQDQOpTest<uint16_t>("GridSample",
                         {TestInputDef<float>({1, 1, 3, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 6)),
                          TestInputDef<float>({1, 2, 4, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 16))},
                         {utils::MakeAttribute("align_corners", static_cast<int64_t>(1)),
...
// Issue fixed in 2.30
TEST_F(QnnHTPBackendABITests, GridSample_BorderPadding) {
  RunQDQOpTest<uint8_t>("GridSample",
...
TEST_F(QnnHTPBackendABITests, GridSample_Nearest) {
  RunQDQOpTest<uint8_t>("GridSample",
                        {TestInputDef<float>({1, 1, 3, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 6)),
                         TestInputDef<float>({1, 2, 4, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 16))},
...
TEST_F(QnnHTPBackendABITests, GridSample_U16_Nearest) {
  RunQDQOpTest<uint16_t>("GridSample",
                         {TestInputDef<float>({1, 1, 3, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 6)),
                          TestInputDef<float>({1, 2, 4, 2}, false, GetFloatDataInRange(-10.0f, 10.0f, 16))},
                         {utils::MakeAttribute("mode", "nearest")},
...
// fixed by QNN 2.32
TEST_F(QnnHTPBackendABITests, GridSample_ReflectionPaddingMode) {
  RunQDQOpTest<uint8_t>("GridSample",
                        {TestInputDef<float>({1, 1, 3, 2}, false, -10.0f, 10.0f),
                         TestInputDef<float>({1, 2, 4, 2}, false, -10.0f, 10.0f)},
...
TEST_F(QnnHTPBackendABITests, VariadicOp_Concat_3Inputs_LastAxis) {
...
TEST_F(QnnHTPBackendABITests, VariadicOp_Concat_2Inputs_2ndAxis) {
  RunQDQOpTest<uint8_t>("Concat",
                        {TestInputDef<float>({1, 2, 2, 2}, false, -10.0f, 10.0f),
...
TEST_F(QnnHTPBackendABITests, LpNormalization_u8_rank4) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
TEST_F(QnnHTPBackendABITests, LpNormalization_u16_rank4) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
TEST_F(QnnHTPBackendABITests, Add_U8_U16_Convert) {
  std::vector<float> input0_data = GetFloatDataInRange(-10.0f, 10.0f, 8);
...
TEST_F(QnnHTPBackendABITests, DQ_Q_ConvertFusion_SameType) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSigmoid_QU8) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSigmoid_QU16) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSigmoid_QDQ_Supported) {
  RunQDQOpTest<uint8_t>("HardSigmoid",
                        {TestInputDef<float>({1, 2, 2, 2}, false, -10.0f, 10.0f)},
                        {},
                        19,
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSigmoid_F32_as_FP16) {
...
TEST_F(QnnHTPBackendABITests, UnaryOp_HardSigmoid_FP16) {
  std::vector<float> input_data = GetFloatDataInRange(-5.0f, 5.0f, 16);
...
TEST_F(QnnHTPBackendABITests, HardSigmoidFusedIntoHardSwish_FP32_as_FP16) {
  ProviderOptions provider_options;
...
TEST_F(QnnHTPBackendABITests, HardSigmoidFusedIntoHardSwish_FP16) {
  ProviderOptions provider_options;
