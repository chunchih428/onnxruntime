...
TEST_F(QnnCPUBackendABITests, Reshape_DynamicShape_Unsupported) {
...
TEST_F(QnnCPUBackendABITests, Reshape_AllowZeroAttr_Unsupported) {
...
TEST_F(QnnCPUBackendABITests, Reshape_4D_f32) {
...
TEST_F(QnnCPUBackendABITests, Expand_NonIniShape) {
...
TEST_F(QnnCPUBackendABITests, Expand_IniShape) {
  RunReshapeExpandTestOnCPU("Expand", TestInputDef<float>({1}, false, {1.0f}),
...
// Test Expand with initializer shape input.
TEST_F(QnnCPUBackendABITests, Expand_Uint32) {
...
TEST_F(QnnCPUBackendABITests, Expand_6D) {
...
TEST_F(QnnHTPBackendABITests, Reshape_DynamicShape_Unsupported) {
...
TEST_F(QnnHTPBackendABITests, Reshape_AllowZeroAttr_Unsupported) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Reshape",
                                        TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),
                                        TestInputDef<int64_t>({2}, true, {1, 48}),
                                        {utils::MakeAttribute("allowzero", static_cast<int64_t>(1))},
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_u8) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Reshape",
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_u16) {
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_int32) {
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_int64) {
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_0MeansCopy) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Reshape",
                                        TestInputDef<float>({1, 3, 4, 4}, false, GetFloatDataInRange(-10.0f, 10.0f, 48)),
...
TEST_F(QnnHTPBackendABITests, Reshape_4D_Neg1MeansInfer) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Reshape",
                                        TestInputDef<float>({1, 3, 4, 4}, false, GetFloatDataInRange(-10.0f, 10.0f, 48)),
...
TEST_F(QnnHTPBackendABITests, Expand_HTP_int32) {
...
TEST_F(QnnHTPBackendABITests, Expand_HTP_int64) {
...
TEST_F(QnnHTPBackendABITests, Expand_HTP_bool) {
...
// Test QDQ Expand
TEST_F(QnnHTPBackendABITests, Expand_4D) {
...
// Test QDQ Expand
TEST_F(QnnHTPBackendABITests, Expand_5D) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Expand",
...
TEST_F(QnnHTPBackendABITests, Expand_6D) {
  RunQDQReshapeExpandTestOnHTP<uint8_t>("Expand",
                                        TestInputDef<float>({1, 3}, false, {1.0f, 2.0f, 3.0f}),
