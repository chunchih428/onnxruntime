...
TEST_F(QnnCPUBackendABITests, Clip_Dynamic_MinMax_Unsupported) {
...
TEST_F(QnnCPUBackendABITests, Clip_4D_f32_DefaultMinMax) {
...
TEST_F(QnnCPUBackendABITests, Clip_5D_f32) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_Clip_f32) {
...
TEST_F(QnnHTPBackendABITests, Clip_int32) {
  bool on_cpu_backend = false;
...
TEST_F(QnnHTPBackendABITests, Clip_U8_DefaultMinMax_Rank4) {
...
// - ClipQuantFusion: Fuses Clip -> QuantizeLinear resulting in Q1 -> DQ1 -> Q2' -> DQ2
// - DoubleQDQPairsRemover: Simplifies remaining Q1 -> DQ1 -> Q2' -> DQ2 sequence to Q1 -> DQ2.
TEST_F(QnnHTPBackendABITests, Clip_U16_DefaultMinMax_Rank4) {
...
TEST_F(QnnHTPBackendABITests, Clip_U8_Rank4) {
  RunQDQClipTestOnHTP<uint8_t>(TestInputDef<float>({1, 3, 4, 4}, false, GetFloatDataInRange(-10.0f, 10.0f, 48)),
                               {TestInputDef<float>({}, true, {-5.0f}),
                                TestInputDef<float>({}, true, {5.0f})},
                               ExpectedEPNodeAssignment::All);
...
TEST_F(QnnHTPBackendABITests, Clip_U16_Rank4) {
  RunQDQClipTestOnHTP<uint16_t>(TestInputDef<float>({1, 3, 4, 4}, false, GetFloatDataInRange(-10.0f, 10.0f, 48)),
                                {TestInputDef<float>({}, true, {-5.0f}),
                                 TestInputDef<float>({}, true, {5.0f})},
                                ExpectedEPNodeAssignment::All,
...
TEST_F(QnnHTPBackendABITests, Clip_U8_Rank5) {
...
TEST_F(QnnHTPBackendABITests, Clip_FP16) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
