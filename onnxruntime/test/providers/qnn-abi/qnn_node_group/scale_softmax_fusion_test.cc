...
TEST_F(QnnHTPBackendABITests, DISABLED_ScaleSoftmaxFusionScalarInitializer) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_ScaleSoftmaxFusionScalarConstant) {
  ProviderOptions provider_options = GetProviderOptions();
...
TEST_F(QnnHTPBackendABITests, DISABLED_ScaleSoftmaxFusionScalarInitializerReversed) {
  ProviderOptions provider_options = GetProviderOptions();
  auto input_def = TestInputDef<float>({1, 3, 5, 5}, false, -0.5f, 0.5f);
...
TEST_F(QnnHTPBackendABITests, DISABLED_ScaleSoftmaxFusionScalarConstantReversed) {
  ProviderOptions provider_options = GetProviderOptions();
  auto input_def = TestInputDef<float>({1, 3, 5, 5}, false, -0.5f, 0.5f);
...
TEST_F(QnnHTPBackendABITests, DISABLED_ScaleSoftmaxFusionSoftmaxNegativeAxis) {
  ProviderOptions provider_options = GetProviderOptions();
  auto input_def = TestInputDef<float>({1, 3, 5, 5}, false, -0.5f, 0.5f);
...
TEST_F(QnnHTPBackendABITests, ScaleSoftmaxFusionSkipNoScalar4d) {
  ProviderOptions provider_options = GetProviderOptions();
...
TEST_F(QnnHTPBackendABITests, ScaleSoftmaxFusionSkipNoScalar1d) {
  ProviderOptions provider_options = GetProviderOptions();
  auto input_def1 = TestInputDef<float>({1, 3, 5, 5}, false, -0.5f, 0.5f);
