...
TEST_F(QnnCPUBackendABITests, Slice_SharedInitializersBugFix) {
...
TEST_F(QnnHTPBackendABITests, SliceSmallDataQDQU8) {
...
// Check that QNN compiles DQ -> Slice -> Q as a single unit.
TEST_F(QnnHTPBackendABITests, SliceLargePositiveDataQDQU8) {
...
// Check that QNN compiles DQ -> Slice -> Q as a single unit.
TEST_F(QnnHTPBackendABITests, SliceLargeNegativeDataQDQU8) {
  RunSliceQDQTest(TestInputDef<float>({5120}, false, 0.0f, 1.0f),
                  TestInputDef<int64_t>({1}, true, {0}),
                  TestInputDef<int64_t>({1}, true, {-1}),
                  TestInputDef<int64_t>({1}, true, {0}),
...
TEST_F(QnnHTPBackendABITests, SliceInt32OnHTP) {
...
TEST_F(QnnHTPBackendABITests, SliceU8_MultAxes) {
...
TEST_F(QnnHTPBackendABITests, SliceU16_MultAxes) {
  std::vector<float> input_data = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f};
...
TEST_F(QnnHTPBackendABITests, SliceU8_MultAxes_LargeEnd) {
  std::vector<float> input_data = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f};
  RunSliceQDQTest<uint8_t>(TestInputDef<float>({2, 4}, false, input_data),
