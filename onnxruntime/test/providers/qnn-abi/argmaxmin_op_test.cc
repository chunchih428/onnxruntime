...
TEST_F(QnnCPUBackendABITests, ArgMaxMin_DefaultAttrs) {
...
TEST_F(QnnHTPBackendABITests, ArgMaxMinU8_DefaultAttrs) {
...
// Compares output with CPU EP.
TEST_F(QnnHTPBackendABITests, ArgMaxMinU8_AxisLast) {
  RunQDQArgMxxOpTest<uint8_t>("ArgMax",
                              TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),   // Random input.
...
// Compares output with CPU EP.
TEST_F(QnnHTPBackendABITests, ArgMaxMinU8_NotKeepDims) {
  RunQDQArgMxxOpTest<uint8_t>("ArgMax",
                              TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),  // Random input.
...
TEST_F(QnnHTPBackendABITests, ArgMaxMinU8_SelectLastIndex_NonZero_Unsupported) {
  RunQDQArgMxxOpTest<uint8_t>("ArgMax",
                              TestInputDef<float>({1, 3, 4, 4}, false, -10.0f, 10.0f),  // Random input.
...
TEST_F(QnnHTPBackendABITests, ArgMaxMinU8_RankGreaterThan4_Unsupported) {
  RunQDQArgMxxOpTest<uint8_t>("ArgMax",
