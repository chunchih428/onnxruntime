...
TEST_F(QnnCPUBackendABITests, LayerNorm) {
...
TEST_F(QnnCPUBackendABITests, LayerNorm1D_Axis0) {
...
TEST_F(QnnCPUBackendABITests, LayerNorm1D_AxisLast) {
  RunLayerNormCpuTest(TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(0.0f, 10.0f, 6)),
...
TEST_F(QnnCPUBackendABITests, LayerNorm2D) {
...
TEST_F(QnnCPUBackendABITests, LayerNorm3D) {
...
TEST_F(QnnHTPBackendABITests, LayerNorm1D_Axis0_Unsupported) {
...
TEST_F(QnnHTPBackendABITests, LayerNorm1D_LastAxis_StaticScale_AU8_WU8) {
...
TEST_F(QnnHTPBackendABITests, LayerNorm1D_LastAxis_StaticScale_StaticBias_AU8_WU8_BU8) {
  RunLayerNormQDQTest<uint8_t, uint8_t>(TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(0.0f, 10.0f, 6)),
                                        TestInputDef<float>({3}, true, GetFloatDataInRange(0.0f, 1.0f, 3)),
                                        TestInputDef<float>({3}, true, GetFloatDataInRange(0.0f, 1.0f, 3)),
                                        {utils::MakeAttribute("axis", static_cast<int64_t>(-1))},
...
TEST_F(QnnHTPBackendABITests, LayerNorm1D_QNN2_24_ImplicitBias_ValidationBug) {
...
TEST_F(QnnHTPBackendABITests, LayerNorm1D_LastAxis_StaticScale_AU16_WU8) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_LayerNorm1D_LastAxis_DynamicScale) {
  RunLayerNormQDQTest<uint8_t, uint8_t>(TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(0.0f, 10.0f, 6)),
