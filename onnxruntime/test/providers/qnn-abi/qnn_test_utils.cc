...
void QnnHTPBackendABITests::SetUp() {
...
BackendSupport QnnHTPBackendABITests::IsIRBackendSupported() const {
  const auto& logger = DefaultLoggingManager().DefaultLogger();
...
void QnnCPUBackendABITests::SetUp() {
...
void QnnIRBackendABITests::SetUp() {
...
BackendSupport QnnHTPBackendABITests::cached_htp_support_ = BackendSupport::SUPPORT_UNKNOWN;

// TODO: Remove or set to SUPPORTED once CPU backend works on win arm64 (pipeline VM).
BackendSupport QnnCPUBackendABITests::cached_cpu_support_ = BackendSupport::SUPPORT_UNKNOWN;
#else
BackendSupport QnnHTPBackendABITests::cached_htp_support_ = BackendSupport::SUPPORTED;
BackendSupport QnnCPUBackendABITests::cached_cpu_support_ = BackendSupport::SUPPORTED;
#endif  // defined(_WIN32)

BackendSupport QnnHTPBackendABITests::cached_ir_support_ = BackendSupport::SUPPORT_UNKNOWN;
BackendSupport QnnIRBackendABITests::cached_ir_support_ = BackendSupport::SUPPORT_UNKNOWN;
