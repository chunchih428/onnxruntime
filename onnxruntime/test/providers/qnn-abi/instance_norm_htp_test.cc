...
TEST_F(QnnHTPBackendABITests, InstanceNormU8U8) {
...
TEST_F(QnnHTPBackendABITests, InstanceNormU8S8) {
  // Check SFIXED scale
  std::vector<float> input_data = {3.21289f, -5.9981f, -1.72799f, 6.27263f, 3.36205f, -1.93515f, -5.40113f, 3.75648f, 6.15357f,
                                   -5.25769f, 2.73637f, -0.901382f, -6.55612f, 1.99497f, -4.79228f, 2.69813f, 8.3064f, 0.0362501f};
  std::vector<float> scale_data = {-0.148738f, -1.45158f};
...
TEST_F(QnnHTPBackendABITests, InstanceNormU16U8) {
  std::vector<float> input_data = {3.21289f, -5.9981f, -1.72799f, 6.27263f, 3.36205f, -1.93515f, -5.40113f, 3.75648f, 6.15357f,
                                   -5.25769f, 2.73637f, -0.901382f, -6.55612f, 1.99497f, -4.79228f, 2.69813f, 8.3064f, 0.0362501f};
  std::vector<float> scale_data = {-0.148738f, -1.45158f};
  std::vector<float> bias_data = {-2.2785083772f, 2.3338717017f};
...
TEST_F(QnnHTPBackendABITests, InstanceNormU8U8Rank3) {
...
TEST_F(QnnHTPBackendABITests, InstanceNormU8U8Rank3_BatchSizeNot1) {
...
// which requires wrapping the QNN InstanceNorm op with reshapes.
TEST_F(QnnHTPBackendABITests, InstanceNormU16U8Rank3_BatchSizeNot1) {
  std::vector<float> input_data = {6.0f, 4.0f, 2.0f, 6.0f, 8.0f, 2.0f,
                                   -8.0f, -6.0f, 0.0f, 1.0f, 3.0f, 6.0f};
...
TEST_F(QnnHTPBackendABITests, InstanceNormU8U8Rank3_BatchSizeNot1_Initializer) {
  std::vector<float> input_data = {6.0f, 4.0f, 2.0f, 6.0f, 8.0f, 2.0f,
                                   -8.0f, -6.0f, 0.0f, 1.0f, 3.0f, 6.0f};
...
// which requires wrapping the QNN InstanceNorm op with reshapes.
// Input 0 is an initializer.
TEST_F(QnnHTPBackendABITests, InstanceNormU16U8Rank3_BatchSizeNot1_Initializer) {
  std::vector<float> input_data = {6.0f, 4.0f, 2.0f, 6.0f, 8.0f, 2.0f,
                                   -8.0f, -6.0f, 0.0f, 1.0f, 3.0f, 6.0f};
...
TEST_F(QnnHTPBackendABITests, InstanceNormU8U8Rank5) {
