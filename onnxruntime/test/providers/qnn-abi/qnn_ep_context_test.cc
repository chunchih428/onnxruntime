...
TEST_F(QnnHTPBackendABITests, CompileApi_DisableEpCompile_ThenCompileExplicitly) {
...
//   - input model file
//   - output model file
TEST_F(QnnHTPBackendABITests, CompileApi_FromSessionOptions_InputModelFromPath) {
...
TEST_F(QnnHTPBackendABITests, CompileApi_FromSessionOptions_InputModelAsBuffer_Embedded) {
...
TEST_F(QnnHTPBackendABITests, CompileApi_FromSessionOptions_OutputModelBuffer) {
  const ORTCHAR_T* input_model_file = ORT_TSTR("./compileapi_fromsessionoptions_inputmodelfrompath.onnx");
  std::filesystem::remove(input_model_file);
...
TEST_F(QnnHTPBackendABITests, CompileApi_FromSessionOptions_InputAndOutputModelsInBuffers) {
  // Create a test model and serialize it to a buffer.
  TestModel test_model;
  CreateTestModel(BuildGraphWithQAndNonQ(false), 21, logging::Severity::kERROR, test_model);
  std::string model_data = test_model.Serialize();
...
//   - EPContext nodes in output model use embedded binary blobs.
TEST_F(QnnHTPBackendABITests, CompileApi_FromSessionOptions_OutputModelBuffer_OutputInitializersFile) {
...
TEST_F(QnnHTPBackendABITests, CompileApi_SetFlags_ErrorIfNoCompiledNodes) {
...
TEST_F(QnnHTPBackendABITests, CompileApi_SetFlags_ErrorIfOutputFileAlreadyExists) {
  const ORTCHAR_T* input_model_file = ORT_MODEL_FOLDER "mul_1.onnx";
...
TEST_F(QnnHTPBackendABITests, CompileApi_ErrorIfCompilingACompiledModel) {
  const ORTCHAR_T* input_model_file = ORT_MODEL_FOLDER "mul_1.onnx";
  const ORTCHAR_T* output_model_file = ORT_TSTR("mul_1_ctx_.onnx");
  std::filesystem::remove(output_model_file);
...
TEST_F(QnnHTPBackendABITests, QnnContextBinary_OriginalCompileApproach_NoCompiledNodesDoesntGenerateOutput) {
  const ORTCHAR_T* input_model_file = ORT_MODEL_FOLDER "mul_1.onnx";
...
// Also, ORT should not return an error.
TEST_F(QnnHTPBackendABITests, QnnContextBinary_OriginalCompileApproach_IgnoreCompilingOfCompiledModel) {
  const ORTCHAR_T* input_model_file = ORT_MODEL_FOLDER "mul_1.onnx";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryMultiPartitionSupport1) {
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryMultiPartitionSupport2) {
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCpuNodeWithExternalWeights) {
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCpuNodeWithoutExternalWeights) {
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryGenerationFolderPathNotExpected) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryGenerationFolderPathNotExpected2) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryGenerationNoOverWrite) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryGeneration2InputTypes) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextGeneration2InputsOrderIssue) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextGenerationNodeNamePrefix) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCacheEmbedModeTest) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCacheNonEmbedModeTest) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCache_InvalidGraph) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryRelativePathTest) {
...
// Verify that it return INVALID_GRAPH status
TEST_F(QnnHTPBackendABITests, QnnContextBinaryAbsolutePathTest) {
#if defined(_WIN32)
...
// Verify that it return INVALID_GRAPH status
TEST_F(QnnHTPBackendABITests, QnnContextBinaryFileNotExistTest) {
...
// Verify that it return INVALID_GRAPH status
TEST_F(QnnHTPBackendABITests, QnnContextBinaryFileEmptyStringTest) {
...
// 1st run will generate the Qnn context cache onnx file
// 2nd run directly loads and run from Qnn context cache model
TEST_F(QnnHTPBackendABITests, QnnContextBinary2InputsTest) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextBinaryCache_SingleNodeNameNotMatchGraphNameInCtx) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnMultiContextEmbeded) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnMultiContextExternal) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, QnnContextShareAcrossSessions) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, VTCMBackupBufferSharing) {
  ProviderOptions provider_options;
  provider_options["offload_graph_io_quantization"] = "0";
  provider_options["backend_type"] = "htp";
...
TEST_F(QnnHTPBackendABITests, QnnContextGenWeightSharingSessionAPI) {
  ProviderOptions provider_options;
  provider_options["backend_type"] = "htp";
  provider_options["offload_graph_io_quantization"] = "0";
...
TEST_F(QnnHTPBackendABITests, LoadFromArrayWithQnnEpContextGenPathValidation) {
  ProviderOptions provider_options;
#if defined(_WIN32)
