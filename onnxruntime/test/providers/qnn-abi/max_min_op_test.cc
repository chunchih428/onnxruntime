...
TEST_F(QnnCPUBackendABITests, Min_1Input_NotSupported) {
...
TEST_F(QnnCPUBackendABITests, Max_1Input_NotSupported) {
...
TEST_F(QnnCPUBackendABITests, Min_2Inputs) {
...
TEST_F(QnnCPUBackendABITests, Max_2Inputs) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
  RunCPUMinOrMaxOpTest("Max",
                       {TestInputDef<float>({1, 3, 4, 4}, false, input_data),
                        TestInputDef<float>({1, 3, 4, 4}, false, input_data)},
...
TEST_F(QnnHTPBackendABITests, Min_1Input_NotSupported) {
...
TEST_F(QnnHTPBackendABITests, Max_1Input_NotSupported) {
...
TEST_F(QnnHTPBackendABITests, Min_2Inputs) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
...
TEST_F(QnnHTPBackendABITests, Max_2Inputs) {
  std::vector<float> input_data = GetFloatDataInRange(-10.0f, 10.0f, 48);
