...
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesStaticInt64_Axis0) {
...
TEST_F(QnnHTPBackendABITests, GatherOp_U16_IndicesStaticInt64_Axis0) {
...
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesDynamicInt64_Axis0) {
  RunQDQGatherOpTest<uint8_t, int64_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.7f}),
...
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesStaticInt32_Axis0) {
...
// negative indices
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesStaticInt32_NegativeIndices) {
  RunQDQGatherOpTest<uint8_t, int32_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.7f}),
...
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesDynamicInt32_Axis0) {
  RunQDQGatherOpTest<uint8_t, int32_t>(TestInputDef<float>({3, 2}, false, {1.0f, 1.2f, 2.3f, 3.4f, 4.5f, 5.7f}),
...
// Issue fixed in 2.30
TEST_F(QnnHTPBackendABITests, GatherOp_IndicesStaticInt32_Axis1) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_GatherOp_IndicesStaticInt64) {
