 ...
 * --gtest_filter command-line option. Ex: --gtest_filter=QnnHTPBackendABITests.Resize_DownSample_Linear_AlignCorners
 *
...
class QnnHTPBackendABITests : public ::testing::Test {
 protected:
  void SetUp() override;
...
class QnnCPUBackendABITests : public ::testing::Test {
 protected:
  void SetUp() override;
...
class QnnIRBackendABITests : public ::testing::Test {
 protected:
  void SetUp() override;
