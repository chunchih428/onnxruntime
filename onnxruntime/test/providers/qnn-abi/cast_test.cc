...
TEST_F(QnnCPUBackendABITests, TestCastInt32ToFloat) {
...
TEST_F(QnnCPUBackendABITests, TestCastUInt8ToFloat) {
...
TEST_F(QnnCPUBackendABITests, TestCastFloatToInt32) {
...
TEST_F(QnnHTPBackendABITests, TestCastInt32ToFloatHTP) {
...
TEST_F(QnnHTPBackendABITests, DISABLED_TestCastUInt8ToFloatHTP) {
...
TEST_F(QnnHTPBackendABITests, TestCastFloatToInt32HTP) {
...
TEST_F(QnnHTPBackendABITests, TestCastInt64ToInt32HTP) {
...
TEST_F(QnnHTPBackendABITests, TestCastFloat16ToBoolHTP) {
